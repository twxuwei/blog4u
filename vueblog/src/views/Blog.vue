        ...
        <div class="side">
          <side-section>
            <div slot="sidecontent">
              <h3 style="text-align:left;">
                <a href="">Blog4U</a>
                <span class="cat-desc">coding life.</span>
              </h3>
              <div class="pres">
                <a href="" class="pic">
                  <img src="/blog/articles/img?filename=totoro.jpg" alt="我的头像">
                </a>
                <a href="" class="detail">
                <span class="item-info">
                  <span class="item-title">xw</span>
                  <span class="item-desc">Where there is will,there is a way.</span>
                </span>
                </a>
              </div>
              <div class="social">
                <a data-balloon="github" href="https://github.com/cylover945" rel="nofollow" class="icon"><i
          ...
          <side-section>
            <div slot="sidecontent">
              ...
              <div class="tags">
                <span class="tags-item" v-for="item in tags"><a href="#" @click="getOne(item.cateName)">{{item.cateName}}</a></span>
              </div>
            </div>
          </side-section>
...
<script>
  import NavHeader from '@/components/front/Header.vue'
  import NavFooter from '@/components/front/Footer.vue'
  import articleList from '@/components/front/articleList.vue'
  import sideSection from '@/components/front/sideSection.vue'
  ...
  export default {
    ...
    methods: {
      ...
      getMessages() {
        axios.get("/blog/messages/" + this.limit).then((result) => {
          let res = result.data
